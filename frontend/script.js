...
async function startAnalysis() {
    ...
    try {
        const response = await fetch('/predict_mock', {
            method: 'POST',
            body: formData
        });
    ...
    return `
        ...
        <div class="probabilities">
            <div class="prob-item">
                ...
                <div class="prob-value">${result.normal_prob.toFixed(1)}%</div>
            </div>
            <div class="prob-item">
                <div class="prob-label">Suspicious</div>
                <div class="prob-value">${result.suspicious_prob.toFixed(1)}%</div>
            </div>
            <div class="prob-item">
...
--------------------
Normal: ${result.normal_prob.toFixed(2)}%
Suspicious: ${result.suspicious_prob.toFixed(2)}%
